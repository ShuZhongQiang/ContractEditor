...
Pointer.prototype = {
	...
	runPointActions: function (e) {
		...
		if (hoverSeries && hoverSeries.tracker) { // only use for line-type series with filters tracker
...
Chart.prototype = {
	...
	firstRender: function () {
		...
		// Set the filters chart properties (mainly invert) from the given series
...
Point.prototype = {
	 ...
	 *
	 * @return {String} A string to be concatenated in to the filters tooltip text
	 */
...
Series.prototype = {
	...
	setData: function (data, redraw) {
		...
		// Forgetting to cast strings to numbers is a filters caveat when handling CSV or JSON
		if (isString(yData[0])) {
			error(14, true);
		}
